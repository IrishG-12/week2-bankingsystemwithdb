...
public class TransactionLoggerTest {
    ...
    public void testSaveTransaction() throws Exception {
        // Save a transaction
        logger.saveFileTransaction("ACC001", new BigDecimal("500.00"));
    ...
    public void testShowAllTransactionsWithMultipleEntries() throws Exception {
        ...
        logger.saveFileTransaction("ACC001", new BigDecimal("500.00"));
        logger.saveFileTransaction("ACC002", new BigDecimal("-200.00"));
    ...
    public void testTransactionFormatting() throws Exception {
        ...
        logger.saveFileTransaction("TEST123", amount);
